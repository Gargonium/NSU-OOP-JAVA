...
public class WallImage {
    public WallImage(ModelRectangle wall, Group root) {
        ...
        Image grassIcon = new Image(Objects.requireNonNull(this.getClass().getResourceAsStream("/Sprites/landSprites/grass.png")));
        Image dirtIcon = new Image(Objects.requireNonNull(this.getClass().getResourceAsStream("/Sprites/landSprites/dirt.png")));
